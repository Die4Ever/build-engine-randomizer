...
AddMapSettings('Blood', minMapVersion=7, maxMapVersion=7,
    swappableItems={
        518: SpriteInfo('Tome', 'items', lowtag=136, xrepeat=10, yrepeat=10),
        519: SpriteInfo('Doctor\'s Bag', 'items', lowtag=107, xrepeat=12, yrepeat=12),
        ...
        524: SpriteInfo('Flare Pistol', 'weapons', lowtag=43, xrepeat=10, yrepeat=10),
        525: SpriteInfo('Voodoo Doll', 'weapons', lowtag=44, xrepeat=10, yrepeat=10),
        526: SpriteInfo('Napalm Launcher', 'weapons', lowtag=46, xrepeat=10, yrepeat=10),
        539: SpriteInfo('Tesla Cannon', 'weapons', lowtag=45, xrepeat=10, yrepeat=10),
        548: SpriteInfo('Tesla Charge', 'ammo', lowtag=73, xrepeat=6, yrepeat=6),
        558: SpriteInfo('Tommy Gun', 'weapons', lowtag=42, xrepeat=10, yrepeat=10),
        559: SpriteInfo('Sawed Off', 'weapons', lowtag=41, xrepeat=10, yrepeat=10),
        589: SpriteInfo('Bundle of TNT', 'weapons', lowtag=62, xrepeat=10, yrepeat=10),
        618: SpriteInfo('Spray Can', 'weapons', lowtag=60, xrepeat=10, yrepeat=10),
        619: SpriteInfo('4 Shotgun Shells', 'ammo', lowtag=67, xrepeat=10, yrepeat=10),
        760: SpriteInfo('Crystal Ball', 'items', lowtag=121, xrepeat=10, yrepeat=10),
        768: SpriteInfo('Shadow Cloak', 'items', lowtag=126, xrepeat=12, yrepeat=12),
        800: SpriteInfo('Life Leech', 'weapons', lowtag=50, xrepeat=10, yrepeat=10),
        801: SpriteInfo('Gasoline Can', 'ammo', lowtag=79, xrepeat=10, yrepeat=10),
        809: SpriteInfo('Case of TNT', 'weapons', lowtag=63, xrepeat=10, yrepeat=10),
        810: SpriteInfo('Remote Detonator', 'weapons', lowtag=65, xrepeat=10, yrepeat=10),
        811: SpriteInfo('Proximity Detonator', 'weapons', lowtag=64, xrepeat=10, yrepeat=10),
        812: SpriteInfo('Box of Shotgun Shells', 'ammo', lowtag=68, xrepeat=10, yrepeat=10),
        813: SpriteInfo('A Few Bullets', 'ammo', lowtag=69, xrepeat=10, yrepeat=10),
        816: SpriteInfo('Flares', 'ammo', lowtag=76, xrepeat=10, yrepeat=10),
        817: SpriteInfo('Full Drum of Bullets', 'ammo', lowtag=72, xrepeat=10, yrepeat=10),
        820: SpriteInfo('Trapped Soul', 'ammo', lowtag=66, xrepeat=6, yrepeat=6),
        822: SpriteInfo('Medicine Pouch', 'items', lowtag=108, xrepeat=10, yrepeat=10),
        825: SpriteInfo('Invulnerability', 'items', lowtag=114, xrepeat=10, yrepeat=10),
        827: SpriteInfo('Boots of Jumping', 'items', lowtag=115, xrepeat=10, yrepeat=10),
        828: SpriteInfo('Raven Flight', 'items', lowtag=116, xrepeat=12, yrepeat=12),
        829: SpriteInfo('Guns Akimbo', 'items', lowtag=117, xrepeat=10, yrepeat=10),
        830: SpriteInfo('Diving Suit', 'items', lowtag=118, xrepeat=12, yrepeat=12),
        ...
        839: SpriteInfo('Beast Vision', 'items', lowtag=125, xrepeat=10, yrepeat=10),
        840: SpriteInfo('Rage Shroom', 'items', lowtag=127, xrepeat=12, yrepeat=12),
        841: SpriteInfo('Delirium Shroom', 'items', lowtag=128, xrepeat=12, yrepeat=12),
        ...
        896: SpriteInfo('Limited Invisibility', 'items', lowtag=113, xrepeat=10, yrepeat=10),
        2169: SpriteInfo('Life Essence', 'items', lowtag=109, xrepeat=10, yrepeat=10),
        2428: SpriteInfo('Reflective Shots', 'items', lowtag=124, xrepeat=10, yrepeat=10),
        2433: SpriteInfo('Life Seed', 'items', lowtag=110, xrepeat=10, yrepeat=10),
        2578: SpriteInfo('Fire Armor', 'items', lowtag=142, xrepeat=12, yrepeat=12),
        2586: SpriteInfo('Body Armor', 'items', lowtag=141, xrepeat=12, yrepeat=12),
        2594: SpriteInfo('Super Armor', 'items', lowtag=144, xrepeat=12, yrepeat=12),
        2602: SpriteInfo('Spirit Armor', 'items', lowtag=143, xrepeat=12, yrepeat=12),
        2628: SpriteInfo('Basic Armor', 'items', lowtag=140, xrepeat=12, yrepeat=12),
    },
    swappableEnemies={
        832: SpriteInfo('Random Creature', 'monsters', lowtag=200, xrepeat=0, yrepeat=0),
        1170: SpriteInfo('Axe Zombie', 'monsters', lowtag=203, xrepeat=10, yrepeat=10),
        1209: SpriteInfo('Sleep Zombie', 'monsters', lowtag=244, xrepeat=10, yrepeat=10),
        1270: SpriteInfo('Hound', 'monsters', lowtag=211, xrepeat=10, yrepeat=10),
        1370: SpriteInfo('Fat Zombie', 'monsters', lowtag=204, xrepeat=12, yrepeat=12),
        1470: SpriteInfo('Stone Gargoyle', 'monsters', lowtag=207, xrepeat=16, yrepeat=16),
        1530: SpriteInfo('Stone Statue', 'monsters', lowtag=209, xrepeat=10, yrepeat=10),
        1570: SpriteInfo('Gill Beast', 'monsters', lowtag=217, xrepeat=12, yrepeat=12),
        1745: SpriteInfo('Rat', 'monsters', lowtag=220, xrepeat=6, yrepeat=6),
        1792: SpriteInfo('Mother Pod', 'monsters', lowtag=225, xrepeat=10, yrepeat=10),
        1797: SpriteInfo('Mother Tentacle', 'monsters', lowtag=226, xrepeat=10, yrepeat=10),
        1870: SpriteInfo('Eel', 'monsters', lowtag=218, xrepeat=10, yrepeat=10),
        1912: SpriteInfo('Bat', 'monsters', lowtag=219, xrepeat=8, yrepeat=8),
        1920: SpriteInfo('Mother Spider', 'monsters', lowtag=216, xrepeat=20, yrepeat=20),
        1980: SpriteInfo('Hand', 'monsters', lowtag=212, xrepeat=8, yrepeat=8),
        2680: SpriteInfo('Cerberus', 'monsters', lowtag=227, xrepeat=16, yrepeat=16),
        2690: SpriteInfo('Beast', 'monsters', lowtag=251, xrepeat=9, yrepeat=10),
        2820: SpriteInfo('Beast Cultist', 'monsters', lowtag=249, xrepeat=9, yrepeat=10),
        3054: SpriteInfo('Earth Zombie', 'monsters', lowtag=205, xrepeat=10, yrepeat=10),
        3060: SpriteInfo('Phantasm', 'monsters', lowtag=210, xrepeat=10, yrepeat=10),
        3140: SpriteInfo('Tchernobog', 'monsters', lowtag=229, xrepeat=16, yrepeat=16),
        3385: SpriteInfo('Shotgun Cultist Prone', 'monsters', lowtag=246, xrepeat=9, yrepeat=10),
        3798: SpriteInfo('Innocent', 'monsters', lowtag=245, xrepeat=10, yrepeat=10),
