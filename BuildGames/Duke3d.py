...
#AddGame('DUKE.RTS v0.99',                    'Duke Nukem 3D',            175567, '6148685E', '7ECAF2753AA9CC924F746B3D0F36E7C2', 'A9356036AEA01583C85B71410F066285AFE3AF2B', canUseGrpFile=True) # DUKE.RTS v0.99
AddGame('Shareware DUKE3D.GRP v0.99',         'Duke Nukem 3D',           9690241, '02F18900', '56B35E575EBA7F16C0E19628BD6BD934', 'A6341C16BC1170B43BE7F28B5A91C080F9CE3409', canUseGrpFile=True) # Shareware DUKE3D.GRP v0.99
AddGame('Shareware DUKE3D.GRP v1.0',          'Duke Nukem 3D',          10429258, 'A28AA589', '1E57CF6272E8BE0E746666700CC0EE96', '7D2FDF1E9F1BBCE327650B3AECDAF78E6BBD6211', canUseGrpFile=True) # Shareware DUKE3D.GRP v1.0
AddGame('Shareware DUKE3D.GRP v1.1',          'Duke Nukem 3D',          10442980, '912E1E8D', '9B0683A74C8BF36BF85631616385BEC8', '5166D6E4DBBA2B8ABB2FDA48257F0FCBDBF17626', canUseGrpFile=True) # Shareware DUKE3D.GRP v1.1
AddGame('Shareware DUKE3D.GRP v1.3D',         'Duke Nukem 3D',          11035779, '983AD923', 'C03558E3A78D1C5356DC69B6134C5B55', 'A58BDBFAF28416528A0D9A4452F896F46774A806', canUseGrpFile=True) # Shareware DUKE3D.GRP v1.3D
AddGame('Shareware DUKE3D.GRP v1.5 Mac',      'Duke Nukem 3D',          10444391, 'C5F71561', 'B9CAC374477E09459A313CEA457971EA', 'F035E9F0615E3DB23D2DB4C90232D8A95B5B9585', canUseGrpFile=True) # Shareware DUKE3D.GRP v1.5 Mac

AddGame('DUKE3D.GRP v1.3D',                   'Duke Nukem 3D',          26524524, 'BBC9CE44', '981125CB9237C19AA0237109958D2B50', '3D508EAF3360605B0204301C259BD898717CF468', canUseGrpFile=True) # DUKE3D.GRP v1.3D
#AddGame('DUKE.RTS v1.0/1.1/1.3D/1.4/1.5',    'Duke Nukem 3D',            188954, '504086C1', '9D29F9673BBDB56068ACF7645C13749C', '738C7F5FD0C8B57EE2E87AE7A97BF8E21A821D07', canUseGrpFile=True) # DUKE.RTS v1.0/1.1/1.3D/1.4/1.5
AddGame('DUKE3D.GRP v1.4 (Plutonium Pak)',    'Duke Nukem 3D',          44348015, 'F514A6AC', 'C904FFB6A4F3C6080DD1DAC31218B25A', '61E70F883DF9552395406BF3D64F887F3C709438', canUseGrpFile=True) # DUKE3D.GRP v1.4 (Plutonium Pak)
AddGame('DUKE3D.GRP v1.5 (Atomic Edition)',   'Duke Nukem 3D',          44356548, 'FD3DCFF1', '22B6938FE767E5CC57D1FE13080CD522', '4FDEF8559E2D35B1727FE92F021DF9C148CF696C', canUseGrpFile=True) # DUKE3D.GRP v1.5 (Atomic Edition)
...
AddGame('Duke Nukem 3D (South Korean Censored)', 'Duke Nukem 3D', 26385383, 'AA4F6A40', canUseGrpFile=True) # DUKEKR_CRC
AddGame('Duke Nukem 3D MacUser Demo', 'Duke Nukem 3D', 10628573, '73A15EE7', canUseGrpFile=True) # DUKEMD2_CRC
